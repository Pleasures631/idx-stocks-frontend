...
// --- Exodus Broker Summary ---
export interface ExodusBrokerSummaryDB {
  id: number
  stock_code: string
  trade_date: string
  broker_code: string
...
// --- Exodus Flow Analysis ---
export interface ExodusBrokerFlow {
  broker_code: string
  broker_type: string
  buy_value: number
  sell_value: number
...
export interface ExodusFlowPhase {
  symbol: string
  start_date: string
  end_date: string
  total_days: number
  ...
  anomalies: ExodusAnomaly[]
  formatted_buy_value: string
  formatted_sell_value: string
  formatted_net_value: string
  formatted_foreign_net: string
  brokers_accumulation: ExodusBrokerFlow[]
  brokers_distribution: ExodusBrokerFlow[]
  display_status: string
}

export interface ExodusAnomaly {
  stock_code: string
  broker_code: string
  broker_type: string
  trade_date: string
