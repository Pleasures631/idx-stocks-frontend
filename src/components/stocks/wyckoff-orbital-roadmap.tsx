  ...
  return (
    <Card className="relative mt-6 overflow-hidden border-indigo-400/30 bg-slate-950 text-slate-100">
      ...
      <CardHeader className="relative space-y-2">
        ...
        <CardDescription className="text-slate-400">{useReplay ? "Mengikuti roadmap dari tanggal snapshot replay yang berhasil dijalankan." : `Fase terakhir ${baseRoadmap.effective_end_date} - struktur ${baseRoadmap.observed_sessions} sesi - bukan prediksi harga`}</CardDescription>
      </CardHeader>
