...
export function ResetPasswordForm() {
  ...
  return <Card className="w-full max-w-sm"><CardHeader className="text-center"><CardTitle>Reset password</CardTitle><CardDescription>Choose a new password for your account.</CardDescription></CardHeader><CardContent>{done ? <p className="text-sm">Password updated. Redirecting to sign in...</p> : <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
