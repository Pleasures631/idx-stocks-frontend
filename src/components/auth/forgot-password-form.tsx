...
export function ForgotPasswordForm() {
  ...
  return <Card className="w-full max-w-sm"><CardHeader className="text-center"><CardTitle>Forgot password</CardTitle><CardDescription>We&apos;ll send a reset link if the email is registered.</CardDescription></CardHeader><CardContent>
