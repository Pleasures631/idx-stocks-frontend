...
export function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <Card>
        <CardHeader><h2 className="flex items-center gap-2 text-lg font-semibold leading-none tracking-tight">Data & account</h2><CardDescription>Kelola salinan data dan permintaan penghapusan akun.</CardDescription></CardHeader>
